...
export class AuthController {
  ...
  async login(
    ...
    console.log(token)
    response.cookie("auth_for_ocso", token, {
      httpOnly: true,
      secure: false,  // Usa false si no estás usando HTTPS en desarrollo
      sameSite: "none",  // Permite enviar la cookie en solicitudes de diferentes dominios
      expires: expireDate,
